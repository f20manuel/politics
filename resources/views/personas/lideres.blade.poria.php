                                        ...
                                        <div class="modal fade" id="importarModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <form method="POST" action="{{ route('inlideres') }}" accept-charset="utf-8" enctype="multipart/form-data">
                                                        @csrf
                                    ...
                                    <form class="modal-content" action="{{ route('lideres.save') }}" method="POST">
                                      ...
                                      <div class="modal-body text-left">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <input type="number" class="form-control @error('cc') is-invalid @error" id="cc" name="cc" placeholder="Cédula de Ciudadanía" required>
                                                    @error('cc')
